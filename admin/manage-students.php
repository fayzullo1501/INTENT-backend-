        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Students information</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <thead class="thead-dark">
                                        ...
                                        <td><?php echo $row->firstName;?> <?php echo $row->lastName;?> <?php echo $row->middleName;?></td>
