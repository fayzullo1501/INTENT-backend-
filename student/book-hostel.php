...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="../assets/images/faviconn.png">
    <title>INTENT Management System</title>
    <!-- Custom CSS -->
                ...
                <?php
                    ...
                    <div class="alert alert-primary alert-dismissible bg-danger text-white border-0 fade show"
                        ...
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                ...
                                <strong>Info: </strong> You have already booked a course!
                    </div>
                    <?php }
                    else{
						echo "";
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        ...
                        <div class="card-body">
                                ...
                                <div class="custom-control custom-radio">
                                    ...
                                    <label class="custom-control-label" for="customRadio1">Required <code>Extra $120 Per Month</code></label>
                                </div>
                                <div class="custom-control custom-radio">
...
<!--
                ...
                <h4 class="card-title mt-5">Parents Information</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Parent Type</h4>
                                        <div class="form-group">
                                            <input type="text" name="gname" id="gname" class="form-control" placeholder="Enter Parent Type" required>
                                        </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Full name</h4>
                                        <div class="form-group">
                                            <input type="text" name="grelation" id="grelation" required class="form-control" placeholder="Enter Parent's Full Name">
                                        </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Contact Number</h4>
                                        <div class="form-group">
                                            <input type="text" name="gcontact" id="gcontact" required class="form-control" placeholder="Enter Parent's Contact No.">
                                        </div>
                                </div>
                            </div>
                        </div>
