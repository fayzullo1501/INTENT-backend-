        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Details About My Booked Course/Room</h4>
                </div>
                      ...
                      <div class="table-responsive">
                                    <table id="zctb" class="table table-striped table-bordered no-wrap">
                                        ...
                                        while($row=$res->fetch_object())
                                            ...
                                            <td><b>Parent's Type :</b></td>
                                            <td><?php echo $row->guardianName;?></td>
                                            <td><b>Parent's Full Name :</b></td>
                                            <td><?php echo $row->guardianRelation;?></td>
                                            </tr>

                                            <tr>
                                            <td><b>Parent's Contact No. :</b></td>
